...
import MiniGameMayhem


class MiniGameMayhemActivity(sugar3.activity.activity.Activity):
    def __init__(self, handle):
        super(MiniGameMayhemActivity, self).__init__(handle)

        self.paused = False

        # Create the game instance.
        self.game = MiniGameMayhem.MiniGameMayhem()
